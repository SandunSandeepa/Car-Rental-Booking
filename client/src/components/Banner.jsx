...
const Banner = () => {
  return (
    ...
    className='flex flex-col md:flex-row md:items-start items-center justify-between px-8 min-md:md:pl-14 pt-10 bg-gradient-to-r from-[#0558FE] to-[#A9CFFF] max-w-6xl md:w-5xl mx-3 md:mx-auto rounded-2xl overflow-hidden'>
      ...
      transition={{ duration: 0.6, delay: 0.4}}
        src={assets.banner_car_image} alt="car" className='max-h-45 mt-4 md:mt-10'/>
    </Motion.div>
  )
}
